...
@section('panel_content')
    ...
    <div class="container bg-white border shadow rounded px-5 py-4 my-3 fw-600">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4 my-4">
                <div class="document-item card shadow-sm border-light">
    ...
    @if($org_details->status == 0)
        <div class="container bg-white border shadow rounded px-5 py-4 my-3 fw-600">
            <h5 class="text-left ">দয়া করে নিম্নলিখিত শর্তাবলী পড়ুন এবং সম্মতি দিন।</h5>
            <ul>
                <li>সঠিকতা: নিশ্চিত করুন যে জমা দেওয়া তথ্য সঠিক এবং সম্পূর্ণ।</li>
                <li>পর্যালোচনা: জমা দেওয়ার পর, এটি যাচাই করা হবে এবং প্রয়োজনীয় ক্ষেত্রে সংশোধনের অনুরোধ করা হতে পারে।</li>
                <li>গোপনীয়তা: আপনার প্রদত্ত তথ্য নিরাপদ থাকবে এবং অনুমতি ছাড়া তৃতীয় পক্ষের সাথে শেয়ার করা হবে না।</li>
                <li>চূড়ান্ত সিদ্ধান্ত: কর্তৃপক্ষের যাচাইয়ের পর চূড়ান্ত সিদ্ধান্ত জানানো হবে।</li>
                <li>আপনার তথ্য জমা দিতে নিচের "Submit for Verification" ক্লিক করুন।</li>
            </ul>

            <div class="text-left mt-4">
                <a href="{{ route('organization.submit_for_verification') }}" class="btn btn-primary" target="_blank">Submit for
                    Verification</a>
            </div>
        </div>
    @elseif($org_details->status == 1)
        <div class="container bg-success rounded px-5 py-4 my-3 fw-600">
            <div class="text-center text-light fs-4">
                <i class="las la-spinner"></i> {{ translate('Pending For Approval') }}
            </div>
        </div>
