...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('school.uploads.create') }}" class="btn btn-primary">
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route("school.my_uploads.info") }}', {_token: AIZ.data.csrf, id:id}, function(data){
		...
		function bulk_delete() {
            ...
            $.ajax({
                ...
                url: '{{ route("school.bulk-uploaded-files-delete") }}',
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
