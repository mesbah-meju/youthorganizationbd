                ...
                <div class="d-flex">
                    @if($notificationShowDesign != 'only_text')
                        <div class="size-35px mr-2">
                            <img src="{{ uploaded_asset($notificationType->image) }}" onerror="this.onerror=null;this.src='<?php echo static_asset('assets/img/notification.png'); ?>" class="img-fit h-100 {{ $notifyImageDesign }}" >
                        </div>
                    @endif
                    <div>
                        ...
                        @elseif ($notification->type == 'App\Notifications\PayoutNotification')
                            ...
                            @endphp
                        @endif
                        <a href="{{ ($user_type == 'admin' || $user_type == 'wellbeing') ?
