                                ...
                                <ul class="nav nav-tabs nav-justified" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link text-dark active" data-toggle="tab" data-type="order" href="javascript:void(0);"
                                            data-target="#notifications" role="tab" id="orders-tab">{{ translate('Notifications') }}</a>
                                    </li>
                                </ul>
                    ...
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);"
                        ...
                        <span class="d-flex align-items-center">
                            <span class="d-none d-md-block">
                                ...
                                <span class="d-block small opacity-60 text-right">{{ Auth::user()->getRoleNames()->first(); }}</span>
                            </span>
