                        ...
                        function (data) {
                            ...
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    ...
                                    if (data[i].type === "image") {
                                        thumb =
                                            '<a href="'+ data[i].file_name +'" target="_blank"><img src="' +
                                            data[i].file_name +
                                            '" class="img-fit"></a>';
                                    } else {
                                        thumb =
                                            '<a href="'+ data[i].file_name +'" target="_blank"><i class="la la-file-text"></i></a>';
                                    }
                                    var html =
                                        '<a><div class="d-flex justify-content-between align-items-center mt-2 file-preview-item" data-id="' +
                                        data[i].id +
                                        '" title="' +
                                        data[i].file_original_name +
                                        "." +
