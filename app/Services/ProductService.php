...
class ProductService
{
    ...
    {   
        ...
        $products = in_array($auth_user->user_type, ['admin', 'wellbeing']) ? $products->where('products.added_by', 'admin') : $products->where('products.user_id', $auth_user->id);
    ...
    public function setCategoryWiseDiscount(array $data)
    {
        ...
        if(in_array($auth_user->user_type, ['admin', 'wellbeing']) && $seller_product_discount == 0){
