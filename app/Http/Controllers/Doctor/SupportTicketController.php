...
class SupportTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('doctor.support_ticket.index', compact('tickets'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($ticket->save()){
            ...
            return redirect()->route('doctor.support_ticket.index');
        }
        else{
    ...
    public function show($id)
    {
        ...
        return view('doctor.support_ticket.show', compact('ticket','ticket_replies'));
    }
