...
class AizUploadController extends Controller
{
    ...
    {
        $all_uploads = (auth()->user()->user_type == 'school' || auth()->user()->user_type == 'doctor') ? Upload::where('user_id', auth()->user()->id) : Upload::query();
        $search = null;
        $sort_by = null;
        ...
        if(auth()->user()->user_type == 'school') {
            return view('school.uploads.index', compact('all_uploads', 'search', 'sort_by'));
        } else if(auth()->user()->user_type == 'doctor') {
            return view('doctor.uploads.index', compact('all_uploads', 'search', 'sort_by'));
        } else {
    ...
    public function create()
    {
        ...
        if(auth()->user()->user_type == 'school') {
            return view('school.uploads.create');
        } else if(auth()->user()->user_type == 'doctor') {
            return view('doctor.uploads.create');
        } else {
    ...
    public function destroy($id)
    {
        ...
        if ((auth()->user()->user_type == 'school' && $upload->user_id != auth()->user()->id) or (auth()->user()->user_type == 'doctor' && $upload->user_id != auth()->user()->id)) {
    ...
    //File Info Project Attachment
    public function file_info(Request $request)
    {
        $file = Upload::findOrFail($request['id']);

        if(auth()->user()->user_type == 'school') {
            return view('school.uploads.info', compact('file'));
        } else if(auth()->user()->user_type == 'doctor') {
            return view('doctor.uploads.info', compact('file'));
        } else {
