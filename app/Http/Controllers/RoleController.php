...
class RoleController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['permission:add_user_role'])->only('create');
        $this->middleware(['permission:edit_user_role'])->only('edit');
        $this->middleware(['permission:delete_user_role'])->only('destroy');
    }
